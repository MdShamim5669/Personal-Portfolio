...
export const ProjectsSection = ({ projects = [] }) => {
  ...
  // Use only real projects fetched from backend/database
    ...
    <section id="projects" className="w-full py-20 px-4 lg:px-8 bg-[#080B14] border-t border-slate-800/60 relative">
      <div className="max-w-7xl mx-auto relative">
        ...
        {displayedProjects.length > 0 ? (
          ...
          <div className="text-center py-20 text-slate-400 text-sm bg-slate-900/40 rounded-3xl border border-slate-800">
